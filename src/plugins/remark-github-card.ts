...
export const remarkGithubCard: Plugin<[], Root> = () => (tree) => {
  visit(tree, (node, index, parent) => {
    ...
    repoName = repoName.startsWith("https://github.com/") ? repoName.replace("https://github.com/", "") : repoName;
    ...
    if (repoParts.length > 1) {
      ...
      const card = h("div", { id: SimpleUUID, class: "card card-border bg-base-200 skeleton min-h-24" }, [
        h("div", { class: "card-body" }, [
          ...
          h("div", { class: "flex flex-wrap gap-3 mt-2 text-xs" }, [
            h("span", { class: "gh-stars badge badge-ghost badge-sm" }, [{ type: "text", value: "" }]),
            h("span", { class: "gh-forks badge badge-ghost badge-sm" }, [{ type: "text", value: "" }]),
            h("span", { class: "gh-license badge badge-ghost badge-sm" }, [{ type: "text", value: "" }]),
            h("span", { class: "gh-language badge badge-ghost badge-sm ml-auto" }, [{ type: "text", value: "" }]),
          ]),
        ]),
        script,
      ]);
      ...
      const card = h("div", { id: SimpleUUID, class: "card card-border bg-base-200 skeleton min-h-24" }, [
        h("div", { class: "card-body" }, [
          ...
          h("div", { class: "flex flex-wrap gap-3 mt-2 text-xs" }, [
            h("span", { class: "gh-followers badge badge-ghost badge-sm" }, [{ type: "text", value: "" }]),
            h("span", { class: "gh-repos badge badge-ghost badge-sm" }, [{ type: "text", value: "" }]),
            h("span", { class: "gh-location badge badge-ghost badge-sm ml-auto" }, [{ type: "text", value: "" }]),
          ]),
        ]),
        script,
      ]);
